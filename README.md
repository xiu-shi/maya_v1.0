# Maya by Janet Xiu Shi - AI Educator and Digital Twin
...
## SOLAS AI Micro-Qualifications - Janet as Programme Instructor and QA Framework Architect

Janet delivers two of the three QQI-accredited AI micro-qualifications published by SOLAS / Skills to Advance, Ireland's national further education and training authority.

**Official Programme Page:** [solas.ie/programmes/skills-to-advance/ai-micro-qualifications/](https://www.solas.ie/programmes/skills-to-advance/ai-micro-qualifications/)

These programmes are accredited by Quality and Qualifications Ireland (QQI) and delivered by Education and Training Boards (ETBs) across Ireland, in-person, online, or blended. They are highly subsidised for employees, with employer and individual benefits including low-cost access to nationally recognised qualifications.
...
Designed to equip employees with the knowledge, skills, and practical tools required to support the responsible and strategic adoption of AI and GenAI in workplace and organisational contexts. Covering EU AI Act, governance obligations, risk frameworks, and strategic AI deployment planning.

### Janet's Role: Beyond Instruction

Janet did not just deliver these programmes. She designed the quality assurance architecture they run on:

- **MIPLO Framework** (Module Intended Programme Learning Outcome): Bloom's Taxonomy-mapped, assessable learning outcomes authored by Janet at Level 5 where SOLAS does not supply pre-written MIPLOs
- **ALE Evidence Scale** (Applied Learning Evidence): A four-level observation scale replacing binary pass/fail for activity-based AI learning (IA, GA, EU, NYE) - auditable and defensible at QQI accreditation review level
...
### Maya as a Formal AI Educator in These Programmes

Maya is formally documented as a **curriculum-scoped AI Educator** in the QA materials for both programmes. She is believed to be the **first AI agent formally deployed as a teaching resource in an Irish state-funded AI programme**.
...
- Support learners enrolled in my SOLAS programmes between sessions
...
- **Programme Design**: SOLAS QQI Level 4 and Level 5 national AI workforce programmes, MIPLO framework, ALE evidence scale, AI-ARM framework
...
- Supports learners enrolled in QQI Level 4 and Level 5 SOLAS / Skills to Advance programmes
...
**For Partners:** "Can Janet speak at our AI event?" - Speaking topics grounded in GDG leadership, Lakera recognition, and SOLAS programme expertise

**For Students:** "What certifications should I pursue for AI careers?" - Insights from Janet's AWS, Google Cloud, Harvard, and QQI credentials
...
> **Ready to turn complexity into your competitive advantage?** Connect with Janet about AI adoption, cloud strategy, governance, educational curriculum design, or speaking opportunities.
...
我为企业提供可执行的智能转型方案，为教育机构设计面向未来的教学范式。我的使命是将技术愿景转化为您的增长现实与竞争优势。
...
*From personal solution to national programme infrastructure - because being unavailable shouldn't mean missing opportunities, and because AI education deserves an AI educator.*
